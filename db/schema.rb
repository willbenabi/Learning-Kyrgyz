...
ActiveRecord::Schema[8.0].define(version: 2025_12_13_030116) do
  ...
  create_table "grammar_exam_questions", force: :cascade do |t|
    t.string "level", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category"], name: "index_grammar_exam_questions_on_category"
    t.index ["level"], name: "index_grammar_exam_questions_on_level"
  end

  create_table "grammar_exams", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "level", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["attempted_at"], name: "index_grammar_exams_on_attempted_at"
    t.index ["user_id", "level"], name: "index_grammar_exams_on_user_id_and_level"
    t.index ["user_id"], name: "index_grammar_exams_on_user_id"
  end
  ...
  add_foreign_key "grammar_exams", "users"
