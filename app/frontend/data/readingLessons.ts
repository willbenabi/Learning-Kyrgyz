...
type: 'open_ended'
  ...
  },
  {
    ...
    order: 2,
    title: {
      en: 'The Philosophy of Nomadic Worldview',
      ru: 'Философия кочевого мировоззрения'
    },
    description: {
      en: 'Philosophical essay on nomadic culture',
      ru: 'Философское эссе о кочевой культуре'
    },
    text: 'Көчмөн дүйнө таанымы — табият менен адамдын ажырагыс байланышынын философиясы. Жайлоого көчүү — бул жөн гана географиялык жылыш эмес, бул экологиялык мейкиндикте гармониялуу жашоонун көрүнүшү. Көчмөн элдердин акыл-эси табиятты тутунуучу катары эмес, өз ара аракеттенүүчү катары кабыл алган. Бул көз караш заманбап экологиялык кризистин учурунда өзгөчө актуалдуулукка ээ. Улуттук аң-сезимдин терең катмарларында сакталган бул карым-катнаш азыркы муунга философиялык багыт берүүчү болуп калат.',
    textType: {
    ...
    questions: [
      {
        id: 'q1',
        question: 'Көчмөн дүйнө таанымынын негизги принциби эмнеде?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: 'Жайлоого көчүү кандай философиялык мааниге ээ?',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Көчмөн элдердин табиятка болгон мамилеси кандай өзгөчөлүккө ээ?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Эмне үчүн бул философия азыркы учурда актуалдуу?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Текстте сунушталган идеяларды заманбап экологиялык көйгөйлөр контекстинде талкуулаңыз.',
        type: 'open_ended'
      }
    ]
  },
  {
    ...
    order: 3,
    title: {
      en: 'Linguistic Identity and National Consciousness',
      ru: 'Языковая идентичность и национальное сознание'
    },
    description: {
      en: 'Academic essay on language and identity',
      ru: 'Академическое эссе о языке и идентичности'
    },
    text: 'Тилдик идентитет улуттук аң-сезимдин формалашуусунда детерминанттык ролду аткарат. Лингвистикалык код жөн гана коммуникациялык функцияга эмес, концептуалдык дүйнө сүрөтүнө да ээ. Кыргыз тилинин лексикалык-семантикалык өзгөчөлүктөрү этностук дүйнө таанымдын уникалдуулугун чагылдырат. Көп тилдүүлүк шарттарында ата мекендик тилдин позициясы когнитивдик-маданий баалуулуктардын трансформациясын аныктайт. Тил катары жашаса, элдин руханий коду сакталат.',
    textType: {
      en: 'Academic essay',
    ...
    questions: [
      {
        id: 'q1',
        question: 'Тилдик идентитет улуттук аң-сезимге кандай таасирин тийгизет?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: '"Концептуалдык дүйнө сүрөтү" деген эмнени билдирет?',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Кыргыз тилинин өзгөчөлүктөрү эмнени чагылдырат?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Көп тилдүүлүк шарттарында тилдин позициясы эмне үчүн маанилүү?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Автордун "Тил катары жашаса, элдин руханий коду сакталат" деген тезисин талкуулаңыз.',
        type: 'open_ended'
      }
    ]
  },
  {
    ...
    order: 4,
    title: {
      en: 'Postcolonial Discourse in Central Asian Literature',
      ru: 'Постколониальный дискурс в центральноазиатской литературе'
    },
    description: {
      en: 'Literary criticism essay',
      ru: 'Литературно-критическое эссе'
    },
    text: 'Постколониалдык дискурс Борбордук Азия адабиятында идентитеттин кайра курулушунун маанилүү аспектиси болуп саналат. Империялык мезгилдин травмасы жана аны кайра ой жүгүртүүнүн аракети заманбап прозанын доминанттык темасы. Кыргыз жазуучулары маданий гибриддүүлүктүн феноменин ар кандай дискурсивдик стратегиялар аркылуу чагылдырышат. Улуттук нарративдин деколонизациясы каармандардын лингвистикалык жана маданий эки туугандыгында көрүнөт. Бул адабий процесстин концептуализациясы постсоветтик мезгилдеги идентитеттин трансформациясын түшүнүүгө жардам берет.',
    textType: {
    ...
    questions: [
      {
        id: 'q1',
        question: 'Постколониалдык дискурс адабиятта кандай ролду ойнойт?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: '"Маданий гибриддүүлүк" деген түшүнүктү түшүндүрүп бериңиз.',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Улуттук нарративдин деколонизациясы кандай көрүнөт?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Империялык мезгилдин травмасы адабиятта кантип чагылдырылат?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Бул адабий процесстин заманбап идентитетти түшүнүүгө кандай мааниси бар?',
        type: 'open_ended'
      }
    ]
  },
  {
    ...
    order: 5,
    title: {
      en: 'Epistemology of Traditional Knowledge Systems',
      ru: 'Эпистемология традиционных систем знания'
    },
    description: {
      en: 'Philosophical analysis',
      ru: 'Философский анализ'
    },
    text: 'Салттуу билим системаларынын эпистемологиясы эмпирикалык жана трансценденттик өлчөмдөрдүн синтези катары түшүнүлөт. Көчмөн коомдордогу билимдин трансмиссиясы ооздук традициянын герменевтикасына негизделет. Акылмандардын дискурсу метафоралык тилдин аркасында түшүнүктүүлүккө ээ болот, бул архетиптик символизмди колдонууну талап кылат. Заманбап илим-билим менен салттуу билимдердин диалогу интердисциплинардык методологияны жаратат. Бул эки парадигманын конвергенциясы когнитивдик плюрализмди жана маданий релятивизмди баалоону күчөтөт.',
    textType: {
      en: 'Philosophical analysis',
      ru: 'Философский анализ'
    },
    questions: [
      {
        id: 'q1',
        question: 'Салттуу билим системалары кандай негизде түшүнүлөт?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: 'Ооздук традициянын герменевтикасы эмнени билдирет?',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Метафоралык тил жана архетиптик символизм кандай ролду ойнойт?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Заманбап илим-билим менен салттуу билимдердин диалогу эмнеге алып келет?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Когнитивдик плюрализм жана маданий релятивизм тезистерин талкуулаңыз.',
        type: 'open_ended'
      }
    ]
  },
  {
    ...
    order: 6,
    title: {
      en: 'Narrative Strategies in Epic Tradition',
      ru: 'Нарративные стратегии в эпической традиции'
    },
    description: {
      en: 'Literary analysis of epic narratives',
      ru: 'Литературный анализ эпических нарративов'
    },
    text: '"Манас" эпосунун нарративдик структурасы полифониялык дискурстун уникалдуу үлгүсүн көрсөтөт. Манасчылардын перформативдик искусствосу импровизациялык жана канондук элементтердин диалектикалык бирдигине негизделет. Эпикалык хронотоп мифологиялык жана тарыхый мезгилдердин стратификациясын чагылдырат. Каармандын дискурсу архаикалык тилдик формулаларды заманбап интерпретация менен бириктирет. Бул фольклордук жанрдын эстетикалык өзгөчөлүгү аны литературалык канондун маанилүү компоненттине айландырат.',
    textType: {
      en: 'Literary analysis',
      ru: 'Литературный анализ'
    },
    questions: [
      {
        id: 'q1',
        question: '"Манас" эпосунун нарративдик структурасы кандай өзгөчөлүккө ээ?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: 'Манасчылардын перформативдик искусствосунун негизги принциптери эмнеде?',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Эпикалык хронотоп эмнени чагылдырат?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Каармандын дискурсунда кандай элементтер айкалышат?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Фольклордук жанрдын эстетикалык өзгөчөлүгү кандай мааниге ээ?',
        type: 'open_ended'
      }
    ]
  },
  {
    ...
    order: 7,
    title: {
      en: 'Sociolinguistic Dynamics of Language Contact',
      ru: 'Социолингвистическая динамика языковых контактов'
    },
    description: {
      en: 'Sociolinguistic research',
      ru: 'Социолингвистическое исследование'
    },
    text: 'Тилдик контакттын социолингвистикалык динамикасы көп маданияттуу контекстте лингвистикалык идентитеттин трансформациясын аныктайт. Кыргыз тилинин социолингвистикалык ландшафты билингвизм жана код алмаштыруунун татаал патерндерин көрсөтөт. Доминанттык тилдин экспансиясы миноритардык тилдин функционалдык домендеринин сужулушуна алып келет. Лингвистикалык планировканын стратегиялары тилдик плюрализмди сактоого багытталган. Социолингвистикалык изилдөөлөр тилдик саясаттын эффективдүүлүгүн баалоого мүмкүндүк берет.',
    textType: {
      en: 'Sociolinguistic research',
      ru: 'Социолингвистическое исследование'
    },
    questions: [
      {
        id: 'q1',
        question: 'Тилдик контакт лингвистикалык идентитетке кандай таасирин тийгизет?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: 'Билингвизм жана код алмаштыруу эмнени билдирет?',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Доминанттык тилдин экспансиясынын кесепеттери кандай?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Лингвистикалык планировканын негизги максаты эмне?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Социолингвистикалык изилдөөлөрдүн практикалык мааниси эмнеде?',
        type: 'open_ended'
      }
    ]
  },
  {
    ...
    order: 8,
    title: {
      en: 'Hermeneutics of Cultural Memory',
      ru: 'Герменевтика культурной памяти'
    },
    description: {
      en: 'Cultural studies essay',
      ru: 'Культурологическое эссе'
    },
    text: 'Маданий эстин герменевтикасы коллективдүү идентитеттин конструкциясында фундаменталдык мааниге ээ. Эс тутум жөн гана ретроспективдик функцияга эмес, проспективдик багытка да ээ болот. Салттуу жомоктордун, ырлардын жана башка фольклордук жанрлардын трансмиссиясы мнемониктик практикалардын негизги механизми болуп саналат. Маданий эстин дискурсу инклюзивдүү жана эксклюзивдүү нарративдердин селекциясын камтыйт. Постмодерндик контекстте маданий эстин плюрализациясы альтернативдүү тарыхый нарративдердин легитимдештирилишине алып келет.',
    textType: {
      en: 'Cultural studies',
      ru: 'Культурологическое исследование'
    },
    questions: [
      {
        id: 'q1',
        question: 'Маданий эстин коллективдүү идентитеттеги ролу эмнеде?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: 'Эс тутумдун ретроспективдик жана проспективдик функциялары эмнени билдирет?',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Фольклордук жанрлар мнемониктик практикаларда кандай ролду ойнойт?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Инклюзивдүү жана эксклюзивдүү нарративдер эмнени билдирет?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Маданий эстин плюрализациясы постмодерндик контекстте кандай мааниге ээ?',
        type: 'open_ended'
      }
    ]
  },
  {
    ...
    order: 9,
    title: {
      en: 'Discourse Analysis of Political Rhetoric',
      ru: 'Дискурс-анализ политической риторики'
    },
    description: {
      en: 'Political discourse analysis',
      ru: 'Анализ политического дискурса'
    },
    text: 'Саясий риториканын дискурс-анализи билим берүүнүн манипулятивдик стратегияларын жана идеологиялык позициялануу механизмдерин ачып көрсөтөт. Лингвистикалык жактан эле кооздолгон нарративдер коомдук аң-сезимди формалаштырууда детерминанттык таасирге ээ. Метафоралар жана фреймингдин техникалары реципиенттердин когнитивдик структураларына таасир этет. Критикалык дискурс анализи бийликтик отношениялардын тилдик репрезентациясын изилдейт. Дискурсивдик компетенттүүлүк демократиялык коомдун жарандарынын маанилүү касиети болуп саналат.',
    textType: {
      en: 'Political analysis',
      ru: 'Политический анализ'
    },
    questions: [
      {
        id: 'q1',
        question: 'Саясий риториканын дискурс-анализи эмнени ачып көрсөтөт?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: 'Лингвистикалык нарративдер коомдук аң-сезимге кандай таасирин тийгизет?',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Метафоралар жана фреймингдин техникалары кандай иштейт?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Критикалык дискурс анализинин негизги максаты эмне?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Эмне үчүн дискурсивдик компетенттүүлүк демократиялык коом үчүн маанилүү?',
        type: 'open_ended'
      }
    ]
  },
  {
    ...
    order: 10,
    title: {
      en: 'Intertextuality in Contemporary Prose',
      ru: 'Интертекстуальность в современной прозе'
    },
    description: {
      en: 'Literary theory application',
      ru: 'Применение литературной теории'
    },
    text: 'Интертекстуалдуулук заманбап прозанын эстетикалык стратегиясынын доминанттык принциби болуп саналат. Кыргыз жазуучуларынын чыгармаларында классикалык текстке аллюзиялар, цитаталар жана реминисценциялар палимпсесттик катмарларды түзөт. Диалогикалык карым-катнаш башка текст менен жаңы мааниге ээ болот. Интертекстуалдык стратегиялар окурмандын эрудициясына апелляция кылып, рецепциянын көп деңгээлдүүлүгүн түзөт. Бул постмодерндик поэтиканын өзгөчөлүгү адабияттын өзүн-өзү рефлексиялоо жөндөмүнө күбө берет.',
    textType: {
      en: 'Literary theory',
    ...
    questions: [
      {
        id: 'q1',
        question: 'Интертекстуалдуулук заманбап прозада кандай ролду ойнойт?',
        type: 'open_ended'
      },
      {
        id: 'q2',
        question: 'Палимпсесттик катмарлар эмнени билдирет?',
        type: 'open_ended'
      },
      {
        id: 'q3',
        question: 'Диалогикалык карым-катнаш текстке кандай таасирин тийгизет?',
        type: 'open_ended'
      },
      {
        id: 'q4',
        question: 'Интертекстуалдык стратегиялар окурмандан эмнени талап кылат?',
        type: 'open_ended'
      },
      {
        id: 'q5',
        question: 'Бул постмодерндик поэтиканын өзгөчөлүгү эмнени көрсөтөт?',
        type: 'open_ended'
      }
    ]
  }
