...
export const PLACEMENT_TEST_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: {
      en: ['алма', 'банан', 'нан (not a fruit)', 'алмурут'],
      ru: ['алма', 'банан', 'нан (не фрукт)', 'алмурут']
    },
    correct: 2
  },
  {
  ...
  },
  {
    ...
    options: {
      en: ['Мен', 'келгенде', 'болчу (correct: болгон)', 'үйдө'],
      ru: ['Мен', 'келгенде', 'болчу (правильно: болгон)', 'үйдө']
    },
    correct: 2
  },
  {
