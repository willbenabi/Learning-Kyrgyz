module Ai
  class RecommendationGenerator
    LEVEL_PROMPTS = {
      'A1' => 'Порекомендуй 5-6 простых материалов на кыргызском языке для начинающих (уровень A1): детские сказки, простые песни, мультфильмы. ОБЯЗАТЕЛЬНО укажи для каждого материала: тип (reading/listening/watching), название, краткое описание (1-2 предложения), и РЕАЛЬНУЮ РАБОЧУЮ ССЫЛКУ на конкретный ресурс (YouTube видео, статья на сайте, аудио файл). НЕ оставляй url пустым - найди настоящие ссылки на кыргызские ресурсы.',
      'A2' => 'Порекомендуй 5-6 материалов на кыргызском языке для элементарного уровня (A2): народные сказки, простые рассказы, детские передачи, простые новости. ОБЯЗАТЕЛЬНО укажи для каждого материала: тип (reading/listening/watching), название, краткое описание (1-2 предложения), и РЕАЛЬНУЮ РАБОЧУЮ ССЫЛКУ на конкретный ресурс. Ищи на YouTube, Азаттык, 24.kg, Kaktus Media и других кыргызских сайтах.',
      'B1' => 'Порекомендуй 5-6 материалов на кыргызском языке для среднего уровня (B1): короткие рассказы, новости, документальные фильмы, подкасты. ОБЯЗАТЕЛЬНО укажи для каждого материала: тип (reading/listening/watching), название, краткое описание (1-2 предложения), и РЕАЛЬНУЮ РАБОЧУЮ ССЫЛКУ на конкретный ресурс. Используй ресурсы как YouTube, КТРК, Азаттык, 24.kg, Kaktus Media.',
      'B2' => 'Порекомендуй 5-6 материалов на кыргызском языке для продвинутого среднего уровня (B2): повести, аналитические статьи, художественные фильмы, радиопередачи. ОБЯЗАТЕЛЬНО укажи для каждого материала: тип (reading/listening/watching), название, краткое описание (1-2 предложения), и РЕАЛЬНУЮ РАБОЧУЮ ССЫЛКУ на конкретный ресурс. Ищи на культурных и новостных сайтах Кыргызстана.',
      'C1' => 'Порекомендуй 5-6 сложных материалов на кыргызском языке для продвинутого уровня (C1): классическая литература (Айтматов, Манас), академические лекции, театральные постановки, серьезные документальные фильмы. ОБЯЗАТЕЛЬНО укажи для каждого материала: тип (reading/listening/watching), название, краткое описание (1-2 предложения), и РЕАЛЬНУЮ РАБОЧУЮ ССЫЛКУ на конкретный ресурс. Используй академические и культурные ресурсы.'
    }.freeze
    ...
    def self.generate_for_level(level)
      ...
      system_message = {
        ...
        content: <<~PROMPT
          ...
          - ОБЯЗАТЕЛЬНО указывай реальные работающие ссылки (url не должен быть null)
          - Ищи материалы на YouTube (кыргызские каналы), Азаттык (rus.azattyk.org), 24.kg, Kaktus Media, КТРК
          - Для книг можно использовать okuma.kg, kitep.kg или другие кыргызские библиотеки
